...
<div id="contents">
		...
		<h1>
			It's students portion
			<a href="teacher_index.php">Teachers</a>
		</h1>
			...
			<table id="output_table">
				...
				<tr>
					...
					<td>
						...
						<?php echo "<a href='index.php?action=delete&id=".$value['id']."' onClick= 'return confirm(\"Sure to delete?\")'> Delete </a>"; ?>
					</td>
				</tr>
